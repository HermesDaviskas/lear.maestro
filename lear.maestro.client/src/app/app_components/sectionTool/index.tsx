...
export default function SectionTool({
  ...
  const initialUsedCapacity = section.contents.reduce((sum, val) => sum + val, 0);
  const [usedCapacity, setUsedCapacity] = useState(initialUsedCapacity);
...
// Fill positions top-down by column first
